...
function viewload(view){
	...
	var titleAl = new Ele.Layout("line-title border-box");
	titleAl.setHtml("区域曲线图");
	var alView = new Ele.Layout("charts-view border-box");
	...
	var titleBl = new Ele.Layout("line-title border-box");
	titleBl.setHtml("折线图");
	var blView = new Ele.Layout("charts-view border-box");
	...
	var titleHg = new Ele.Layout("line-title border-box");
	titleHg.setHtml("柱状图");
	var hgView = new Ele.Layout("charts-view border-box");
	...
	var titleRadar = new Ele.Layout("line-title border-box");
	titleRadar.setHtml("雷达图");
	var radarView = new Ele.Layout("charts-view border-box");
	...
	var titleSector = new Ele.Layout("line-title border-box");
	titleSector.setHtml("饼状图");
	var sectorView = new Ele.Layout("charts-view border-box");
