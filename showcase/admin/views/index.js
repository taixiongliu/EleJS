...
function viewload(view){
	...
	var welTitle = new Ele.Layout("welcom-title");
	welTitle.setHtml("欢迎访问xxxxxx平台");
	var welLocation = new Ele.Layout("welcom-location");
	...
	var mlv = new Ele.Layout("welcom-title");
	mlv.setHtml("left：30%");
	var mcv = new Ele.Layout("welcom-title");
	mcv.setHtml("center：40%");
	var mrv = new Ele.Layout("welcom-title");
	...
	var test = new Ele.Layout("welcom-title");
	test.setHtml("test：view 1-->25%");
	var test2 = new Ele.Layout("welcom-title");
	test2.setHtml("test：view 2-->25%");
	var test3 = new Ele.Layout("welcom-title");
	test3.setHtml("test：view 3-->25%");
	var test4 = new Ele.Layout("welcom-title");
